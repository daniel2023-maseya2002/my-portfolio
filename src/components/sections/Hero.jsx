    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center w-full">
          ...
          <div className={`space-y-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="group relative inline-flex">
              ...
              <div className="relative inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/10 dark:bg-teal-500/10 bg-teal-500/5 backdrop-blur-sm border border-teal-500/30 dark:border-teal-500/30 border-teal-500/20">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-teal-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-teal-400"></span>
                </span>
                <span className="text-xs font-semibold text-teal-600 dark:text-teal-300 tracking-wide">
                  {t("hero.status")}
                </span>
              </div>
            </div>

            {/* Premium Heading - REDUCED SIZE */}
            <div className="space-y-2">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.2] tracking-tight">
                ...
                <span className="text-slate-900 dark:text-white block">Digital</span>
                <span className="bg-gradient-to-r from-teal-500 via-emerald-500 to-teal-500 bg-clip-text text-transparent block animate-gradient">
            ...
            {/* Role - REDUCED SIZE */}
            <div>
              <span className="text-lg sm:text-xl lg:text-2xl font-semibold bg-gradient-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent">
                {t("hero.role")}
              </span>
            </div>
            ...
            <div className="flex items-start gap-3 max-w-xl">
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-teal-500 to-emerald-500 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div className="flex flex-wrap gap-2">
                {technologies.map((tech, index) => (
                  ...
                  >
                    ...
                    <div className="relative px-3 py-1.5 rounded-full bg-white/5 dark:bg-white/5 bg-slate-100 backdrop-blur-sm border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:border-teal-500/50 transition-all duration-300 group-hover:scale-105 cursor-default flex items-center gap-1.5">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <a 
                href="#projects" 
                className="group relative px-6 py-3 bg-gradient-to-r from-teal-500 to-emerald-500 text-white rounded-lg font-semibold text-sm overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-teal-500/30 hover:scale-105 active:scale-95"
              >
              ...
              <a 
                href="#contact" 
                className="group relative px-6 py-3 bg-white/5 dark:bg-white/5 bg-slate-100 backdrop-blur-sm text-slate-900 dark:text-white border border-teal-500/30 dark:border-teal-500/30 border-teal-500/20 rounded-lg font-semibold text-sm overflow-hidden transition-all duration-300 hover:bg-teal-500/10 hover:border-teal-400 hover:scale-105 active:scale-95"
              >
                <span className="relative flex items-center gap-2">
                  {t("hero.contactMe")}
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className={`flex justify-center lg:justify-end transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="relative group w-full max-w-[380px]">
              ...
              <div className="absolute -top-5 -right-5 z-30 px-4 py-2 rounded-full bg-gradient-to-r from-slate-100 to-white dark:from-slate-800/90 dark:to-slate-900/90 backdrop-blur-xl border border-teal-500/40 dark:border-teal-500/40 border-teal-500/20 shadow-2xl flex items-center gap-2 animate-float">
                <div className="w-1.5 h-1.5 rounded-full bg-teal-500 animate-pulse"></div>
                <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">{t("hero.softwareEngineer") || "Software Engineer"}</span>
                <div className="w-5 h-5 rounded-full bg-gradient-to-br from-teal-500 to-emerald-500 flex items-center justify-center">
              ...
              {/* Outer glow ring */}
              <div className="absolute -inset-5 bg-gradient-to-r from-teal-500/20 to-emerald-500/20 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-all duration-700" />
              
              {/* Main Card - Premium Glassmorphism */}
              <div className="relative bg-gradient-to-br from-white/80 to-white/50 dark:from-white/10 dark:to-white/5 backdrop-blur-xl rounded-2xl border border-slate-200/50 dark:border-white/20 shadow-2xl overflow-hidden transform transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-teal-500/20">
                
                {/* Card header gradient */}
                <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-teal-500/20 to-transparent pointer-events-none" />
                
                {/* Image Container */}
                <div className="relative p-3 pb-0">
                  <div className="relative overflow-hidden rounded-xl">
                    {/* Animated border gradient */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-teal-500 via-emerald-500 to-teal-500 rounded-xl blur opacity-30 group-hover:opacity-60 transition duration-500"></div>
                    
                    <div className="relative bg-slate-100 dark:bg-slate-900/50 rounded-xl overflow-hidden">
                      <img 
                        src={profilePicture} 
                        alt="Daniel Maseya" 
                    ...
                    {/* Corner accents */}
                    <div className="absolute top-2 left-2 w-8 h-8 border-t-2 border-l-2 border-teal-500/60 rounded-tl-lg z-10" />
                    <div className="absolute bottom-2 right-2 w-8 h-8 border-b-2 border-r-2 border-emerald-500/60 rounded-br-lg z-10" />
                  </div>
                </div>

                {/* Premium Info Section - REDUCED SIZE */}
                <div className="relative p-4 pt-3">
                  {/* Name and title */}
                  <div className="text-center mb-3">
                    <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-0.5">Daniel Maseya</h2>
                    <div className="inline-flex items-center gap-2 px-2 py-0.5 rounded-full bg-teal-500/10 dark:bg-teal-500/10 border border-teal-500/30 dark:border-teal-500/30">
                      <span className="text-xs font-semibold text-teal-600 dark:text-teal-400">{t("hero.role")}</span>
                    </div>
                  </div>

                  {/* Stats Grid */}
                  <div className="grid grid-cols-3 gap-1 pt-2 border-t border-slate-200 dark:border-white/10">
                    <div className="text-center">
                      <p className="text-base font-bold text-slate-900 dark:text-white">2+</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">{t("hero.yearsExp") || "Years Exp"}</p>
                    </div>
                    <div className="text-center">
                      <p className="text-base font-bold text-slate-900 dark:text-white">15+</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">{t("hero.projects") || "Projects"}</p>
                    </div>
                    <div className="text-center">
                      <p className="text-base font-bold text-slate-900 dark:text-white">7+</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">{t("hero.clients") || "Clients"}</p>
                    </div>
                  </div>

                  {/* Contact badge */}
                  <div className="mt-3 p-2 rounded-lg bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10">
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-600 dark:text-slate-400">{t("hero.openForWork") || "Open for work"}</span>
                      <div className="flex items-center gap-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-teal-500 animate-pulse"></span>
                        <span className="text-teal-600 dark:text-teal-400 font-semibold text-xs">{t("hero.available") || "Available"}</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 animate-bounce-slow">
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="w-5 h-8 rounded-full border-2 border-teal-500/30 flex justify-center relative">
            <div className="absolute top-1 w-1 h-1.5 bg-teal-500 rounded-full animate-scroll"></div>
          </div>
        </div>
      </div>
